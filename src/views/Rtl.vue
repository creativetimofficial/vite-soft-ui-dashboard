    ...
    <div class="row">
      <div class="col-lg-3 col-sm-6 mb-lg-0 mb-4">
        <card
          ...
          title="اموال اليوم"
          value="$53,000"
          icon-class="text-white ni ni-money-coins"
          title-color="opacity-7"
          value-color
          percentage="55%+"
          direction-reverse
      ...
      <div class="col-lg-3 col-sm-6 mb-lg-0 mb-4">
        <card
          ...
          title="مستخدمو الیوم"
          value="2,300"
          icon-class="text-white ni ni-world"
          title-color="opacity-7"
          value-color
          percentage="33%+"
          direction-reverse
      ...
      <div class="col-lg-3 col-sm-6 mb-lg-0 mb-4">
        <card
          ...
          title="عملاء جدد"
          value="3,462+"
          icon-class="text-white ni ni-paper-diploma"
          title-color="opacity-7"
          value-color
          percentage="2%-"
          direction-reverse
      ...
      <div class="col-lg-3 col-sm-6">
        <card
          ...
          title="مبیعات"
          value="$103,430"
          icon-class="text-white ni ni-cart"
          title-color="opacity-7"
          value-color
          percentage="5%+"
          direction-reverse
